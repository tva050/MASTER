...
mooring_path = r"C:\Users\trym7\OneDrive - UiT Office 365\skole\MASTER\Data processing\Data\BGEP moorings\data mat"
...
def mooring_data(mooring_path):
	...
	for file in mooring_files_A:
		...
		print(data.keys())  # Print the keys in the file to inspect
