...
def plot_data(lon, lat, si_thickness):
    ...
    ax.gridlines(linewidth=0.5, color='gray', alpha=0.7, linestyle='--')
...
def plot_data1(lon, lat, si_thickness):
    ...
    # Plot the sea ice thickness
    mesh = ax.pcolormesh(lon, lat, si_thickness[0, :, :],
...
if __name__ == "__main__":
    ...
    plot_data1(lon, lat, monthly_mean_thickness)
