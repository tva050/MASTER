...
oct_path = r"C:\Users\trym7\OneDrive - UiT Office 365\skole\MASTER\Data processing\Data\CryoSat-2\UiT product\uit_cryosat2_L3_EASE2_nh25km_2013_03_v3.nc"
...
def single_figure(lat, lon, si_thickness):
    ...
    mesh = ax.pcolormesh(lon, lat, si_thickness, transform=ccrs.PlateCarree(), cmap='plasma', vmin=0, vmax=1, zorder=1, shading='gouraud')
    ...
    #gl.ylocator = plt.FixedLocator(np.arange(0, 81, 10))      # Parallels
