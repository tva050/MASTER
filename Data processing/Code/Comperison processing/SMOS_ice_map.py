...
folder_path_2012= r"C:\Users\trym7\OneDrive - UiT Office 365\skole\MASTER\Data processing\Data\SMOS\2012"
...
if __name__ == "__main__":
    ...
    lat, lon, monthly_mean_thickness = get_data(folder_path_2012)
    plot_data(lon, lat, monthly_mean_thickness)
    #print(lon.shape, lat.shape, monthly_mean_thickness.shape)
    store_to_file(lon, lat, monthly_mean_thickness, r'C:\Users\trym7\OneDrive - UiT Office 365\skole\MASTER\Data processing\Data\SMOS\2012\2012_mean_thickness.nc')